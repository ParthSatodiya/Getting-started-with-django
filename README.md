...
There are two main versions of Python. Python *2.x* and Python *3.x*. From 2020, the support for Python *2.x* will be not supported anymore ([more](https://www.python.org/doc/sunset-python-2/)). So we will be using Python *3.x*.
